pkgname <- "GaworAleksandra"
source(file.path(R.home("share"), "R", "examples-header.R"))
options(warn = 1)
options(pager = "console")
base::assign(".ExTimings", "GaworAleksandra-Ex.timings", pos = 'CheckExEnv')
...
cleanEx()
nameEx("GaworAleksandra-package")
### * GaworAleksandra-package

flush(stderr()); flush(stdout())

base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: GaworAleksandra-package
### Title: A short title line describing what the package does
### Aliases: GaworAleksandra-package GaworAleksandra
### Keywords: package
...
base::cat("GaworAleksandra-package", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
